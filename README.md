...
6. [Ограничения полей (валидация данных)](#ограничения-полей-валидация-данных)
7. [Пошаговая инструкция по установке проекта](#пошаговая-инструкция-по-установке-проекта)
8. [Авторы](#авторы)


## Стэк проекта
- Java 11, Spring Boot, Maven, Lombok, Junit, JDBC, JdbcTest, SQL, H2, Postman
- Тесты: [.postman-test](postman)
